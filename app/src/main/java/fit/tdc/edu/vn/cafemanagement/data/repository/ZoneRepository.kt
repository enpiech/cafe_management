...
class ZoneRepository ( val dataSource: FireBaseDataSource) {
    ...
    fun getAllZones() = dataSource.getZoneList("EfzspceETNgWk56YDOOt",DocumentType.ALL)

    fun getUnitById(id: String) = dataSource.getZone("EfzspceETNgWk56YDOOt", id,DocumentType.SINGLE)
