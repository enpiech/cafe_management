...
class RevenueRepository ( val dataSource: FireBaseDataSource){
    ...
    fun getAllRevenues() = dataSource.getRevenueList("EfzspceETNgWk56YDOOt",DocumentType.ALL)

    fun getRevenue(id: String) = dataSource.getRevenue("EfzspceETNgWk56YDOOt", id,DocumentType.SINGLE)
