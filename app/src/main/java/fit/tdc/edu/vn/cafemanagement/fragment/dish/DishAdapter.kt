...
class DishAdapter : ListAdapter<Material, RecyclerView.ViewHolder>(Material.DIFF_CALLBACK) {
    ...
    inner class MaterialHolder(
        ...
        private fun navigateToView(
            ...
            val direction =
                DishListFragmentDirections.actionViewMaterial(material.id, "Chỉnh sửa hàng hóa")
