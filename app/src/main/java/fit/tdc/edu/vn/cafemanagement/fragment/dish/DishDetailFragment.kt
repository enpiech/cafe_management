...
import fit.tdc.edu.vn.cafemanagement.fragment.material.MaterialDetailFragmentArgs
...
class DishDetailFragment : BaseDetailFragment<Material>(R.layout.fragment_detail_material) {
